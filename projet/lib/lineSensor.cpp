...
void LineSensor::followLineObstacle2ndCurve()
{
    ...
    while (!(isAtStopSignObstacle()))
    {
        ...
        if (middle)
        {
            // comportement similaire à continueStraight();
            navigation.customSpeed(130, 130);
        }

        else if (left)
        {
            // comportement similaire à adjustSlightlyRight();
            navigation.customSpeed(70, 140);
        }

        else if (completelyLeft)
        {
            // comportement similaire à adjustHardlyRight();
            navigation.customSpeed(40, 220);
        }

        else if (right)
        {
            // comportement similaire à adjustSlightlyLeft();
            navigation.customSpeed(140, 70);
        }

        else if (completelyRight)
        {
            // comportement similaire à adjustHardlyLeft();
